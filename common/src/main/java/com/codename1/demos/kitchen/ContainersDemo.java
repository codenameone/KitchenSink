...
public class ContainersDemo extends Demo{
    ...
    public ContainersDemo(Form parentForm) {
        init("Containers", getGlobalResources().getImage("containers-demo.png"), parentForm, "https://github.com/codenameone/KitchenSink/tree/master/common/src/main/java/com/codename1/demos/kitchen/ContainersDemo.java");
    }
